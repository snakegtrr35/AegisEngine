...
class MENU_COMPONENT : public COMPONENT {
	...
	ABSTRACT_OBJECT_TYPE_INFO(COMPONENT, MENU_COMPONENT)
...
class MOUSE_EVENT_COMPONENT : public MENU_COMPONENT {
	...
	ABSTRACT_OBJECT_TYPE_INFO(MENU_COMPONENT, MOUSE_EVENT_COMPONENT)
...
class KEYBOARD_EVENT_COMPONENT : public MENU_COMPONENT {
	...
	ABSTRACT_OBJECT_TYPE_INFO(MENU_COMPONENT, KEYBOARD_EVENT_COMPONENT)
